...
export const ImageMedia: React.FC<MediaProps> = (props) => {
  ...
  const aspectImgClass = aspect
    ? `object-cover w-full h-full absolute top-0 bottom-0 left-0 right-0 my-0`
    : ''
  ...
  return (
    <picture className={cn(aspectImgClass)}>
      <NextImage
        alt={alt || ''}
        className={cn(aspectImgClass, imgClassName)}
        fill={fill}
